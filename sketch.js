...
function draw(){
    ...
    fill("black");
    text("Drag the ball and release the mouse to throw it on the targets",50,200);
    text("Press the space bar to attach the ball bach on the slingshot ",50,230);
    push();
    textSize(10);
...
function End(){
    ...
    fill(255);
    if(gameState === "Win"){
        text("You win! Congratulations!", 450, 50);
    }
    if(gameState === "Lose"){
        text("You Lose :( Try again.", 450, 50);
    }
